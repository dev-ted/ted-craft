...
description: "Emil Kowalski's design-engineering philosophy for UI polish, components, animation decisions, and the invisible details that make software feel great."
---
...
<AttributionCard
  ...
  license="MIT"
  catalogUrl="https://www.ui-skills.com/skills/emilkowalski/emil-design-eng"
/>
...
<RegistryInstallPreview
  cursorCommand={"npx skills add emilkowalski/skills --skill emil-design-eng -a cursor -g -y"}
  claudeCommand={"npx skills add emilkowalski/skills --skill emil-design-eng -a claude-code -g -y"}
  codexCommand={"npx skills add emilkowalski/skills --skill emil-design-eng -a codex -g -y"}
  vscodeCommand={"npx skills add emilkowalski/skills --skill emil-design-eng -a github-copilot -g -y"}
  showInstall={true}>{
