...
description: "Search a UI for places that don't animate but should — and reject everything that shouldn't. Read-only; proposes motion with exact values, does not implement."
---

<div className="not-prose mb-6 flex flex-wrap items-center gap-3">
  <KindBadge kind="skill" />
  <span className="text-sm text-fd-muted-foreground">emilkowalski</span>
</div>
...
<AttributionCard
  ...
  license="MIT"
  catalogUrl="https://www.ui-skills.com/skills/emilkowalski/find-animation-opportunities"
/>
...
<RegistryInstallPreview
  cursorCommand={"npx skills add emilkowalski/skills --skill find-animation-opportunities -a cursor -g -y"}
  claudeCommand={"npx skills add emilkowalski/skills --skill find-animation-opportunities -a claude-code -g -y"}
  codexCommand={"npx skills add emilkowalski/skills --skill find-animation-opportunities -a codex -g -y"}
  vscodeCommand={"npx skills add emilkowalski/skills --skill find-animation-opportunities -a github-copilot -g -y"}
  showInstall={true}>{
