...
description: "Review animation and motion code against a high craft bar — timing, easing, origin, and consistency. Default to flagging; approval is earned."
---
...
<AttributionCard
  ...
  license="MIT"
  catalogUrl="https://www.ui-skills.com/skills/emilkowalski/review-animations"
/>
...
<RegistryInstallPreview
  cursorCommand={"npx skills add emilkowalski/skills --skill review-animations -a cursor -g -y"}
  claudeCommand={"npx skills add emilkowalski/skills --skill review-animations -a claude-code -g -y"}
  codexCommand={"npx skills add emilkowalski/skills --skill review-animations -a codex -g -y"}
  vscodeCommand={"npx skills add emilkowalski/skills --skill review-animations -a github-copilot -g -y"}
  showInstall={true}>{
