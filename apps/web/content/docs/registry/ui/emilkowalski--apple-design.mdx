---
title: "Apple Design"
description: "Apple's approach to fluid, physical interface design — springs, gestures, momentum, and interruptible motion — translated for the web."
---
...
<AttributionCard
  ...
  license="MIT"
  catalogUrl="https://www.ui-skills.com/skills/emilkowalski/apple-design"
/>
...
<RegistryInstallPreview
  cursorCommand={"npx skills add emilkowalski/skills --skill apple-design -a cursor -g -y"}
  claudeCommand={"npx skills add emilkowalski/skills --skill apple-design -a claude-code -g -y"}
  codexCommand={"npx skills add emilkowalski/skills --skill apple-design -a codex -g -y"}
  vscodeCommand={"npx skills add emilkowalski/skills --skill apple-design -a github-copilot -g -y"}
  showInstall={true}>{
