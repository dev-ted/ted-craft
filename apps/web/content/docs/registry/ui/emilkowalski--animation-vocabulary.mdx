...
description: "Reverse-lookup glossary that turns a vague motion description into the exact term — so you can prompt designers or agents with the right words."
---
...
<AttributionCard
  ...
  license="MIT"
  catalogUrl="https://www.ui-skills.com/skills/emilkowalski/animation-vocabulary"
/>
...
<RegistryInstallPreview
  cursorCommand={"npx skills add emilkowalski/skills --skill animation-vocabulary -a cursor -g -y"}
  claudeCommand={"npx skills add emilkowalski/skills --skill animation-vocabulary -a claude-code -g -y"}
  codexCommand={"npx skills add emilkowalski/skills --skill animation-vocabulary -a codex -g -y"}
  vscodeCommand={"npx skills add emilkowalski/skills --skill animation-vocabulary -a github-copilot -g -y"}
  showInstall={true}>{
