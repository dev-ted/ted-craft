...
description: "Survey animation and motion code as a senior motion advisor, then produce prioritized audits and self-contained implementation plans. Read-only — plans improvements, does not apply them."
---
...
<AttributionCard
  ...
  license="MIT"
  catalogUrl="https://www.ui-skills.com/skills/emilkowalski/improve-animations"
/>
...
<RegistryInstallPreview
  cursorCommand={"npx skills add emilkowalski/skills --skill improve-animations -a cursor -g -y"}
  claudeCommand={"npx skills add emilkowalski/skills --skill improve-animations -a claude-code -g -y"}
  codexCommand={"npx skills add emilkowalski/skills --skill improve-animations -a codex -g -y"}
  vscodeCommand={"npx skills add emilkowalski/skills --skill improve-animations -a github-copilot -g -y"}
  showInstall={true}>{
