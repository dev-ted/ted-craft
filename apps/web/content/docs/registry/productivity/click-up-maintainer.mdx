...
<div className="not-prose mb-6 flex flex-wrap items-center gap-3">
  ...
  <span className="text-sm text-fd-muted-foreground">productivity · first-party</span>
</div>

<InstallPanel
  slug="click-up-maintainer"
  cursorCommand={"npx skills add dev-ted/ted-craft --skill click-up-maintainer --path registry/first-party/click-up-maintainer/skill -a cursor -g -y"}
  claudeCommand={"npx skills add dev-ted/ted-craft --skill click-up-maintainer --path registry/first-party/click-up-maintainer/skill -a claude-code -g -y"}
  codexCommand={"npx skills add dev-ted/ted-craft --skill click-up-maintainer --path registry/first-party/click-up-maintainer/skill -a codex -g -y"}
